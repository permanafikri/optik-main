        ...
        <div class="card shadow-sm border-bottom-primary">
            ...
            <div class="card-body">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-5">
                        <div class="input-group">
                            <input value="<?= set_value('jumlah_masuk', $barang_masuk['jumlah_masuk']); ?>" name="jumlah_masuk" id="jumlah_masuk" type="number" readonly="readonly" class="form-control" placeholder="Jumlah Masuk...">
                            <div class="input-group-append">
