        ...
        <div class="card shadow-sm border-bottom-primary">
            ...
            <div class="card-body">
                ...
                <div class="row form-group">
                    <label class="col-md-4 text-md-right" for="id_barang_masuk">ID Transaksi Pembelian</label>
                    <div class="col-md-4">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-5">
                        <div class="input-group">
                            <select name="barang[0][supplier_id]" id="supplier_id" class="custom-select">
                ...
                <div id="form-container2">
                    <div class="barang2">
                        ...
                        <div class="row form-group">
                            ...
                            <div class="col-md-5">
                                <div class="input-group">
                                    <input value="<?= set_value('jumlah_masuk'); ?>" name="barang[0][jumlah_masuk]" id="jumlah_masuk" type="number" class="form-control" placeholder="Jumlah Masuk...">
                                    <div class="input-group-append">
